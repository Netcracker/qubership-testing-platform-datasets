...
public class ListAttributeExportConverterTest {
    ...
    public void setUp() {
        ...
        when(factory.getAttributeExportConverter(any())).thenReturn(new ListAttributeExportConverter());
    }
