...
public class CreateProjectProcessingStrategy implements ProcessingStrategy<ProjectEvent, EventType> {
    ...
    public void process(ProjectEvent projectEvent) {
        visibilityAreaService.create(projectEvent.getProjectId(), projectEvent.getProjectName());
    }
