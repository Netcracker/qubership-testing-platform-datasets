...
public class UpdateProjectProcessingStrategy implements ProcessingStrategy<ProjectEvent, EventType> {
    ...
    public void process(ProjectEvent projectEvent) {
        visibilityAreaService.rename(projectEvent.getProjectId(), projectEvent.getProjectName());
    }
