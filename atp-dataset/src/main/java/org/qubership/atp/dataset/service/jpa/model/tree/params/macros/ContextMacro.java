...
public class ContextMacro extends AbstractMacro {
    public static final String MACRO_NAME = "CONTEXT";
    ...
    public String getEvaluatedValue(List<String> arguments) {
        String childrenValue = String.join(EMPTY, arguments);
        if (getMacroContext() == null) {
            return childrenValue;
        }
        String atpContextValue = getMacroContext().getValueFromAtpContext(childrenValue);
        String notFoundMessage = childrenValue + " not found";
        return atpContextValue != null ? atpContextValue : notFoundMessage;
    }
}
