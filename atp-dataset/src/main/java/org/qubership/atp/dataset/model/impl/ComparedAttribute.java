...
public class ComparedAttribute {
    ...
    private AttributeTypeName leftAttributeType;
    private boolean  leftAttributeIsOverlap;
    private UUID rightAttributeId;
    private Object rightAttributeValue;
    private AttributeTypeName rightAttributeType;
    private boolean rightAttributeIsOverlap;
    private String attributeName;
    private DetailedComparisonStatus status;
