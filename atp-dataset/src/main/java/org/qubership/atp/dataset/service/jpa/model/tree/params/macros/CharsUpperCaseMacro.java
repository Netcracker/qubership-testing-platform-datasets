...
@Deprecated
public class CharsUpperCaseMacro extends CharsMacro {
    public static final String MACRO_NAME = "CHARS_UPPERCASE";

    public CharsUpperCaseMacro(String realMacroName,
    ...
    public String getEvaluatedValue(List<String> arguments) {
        return Strings.toUpperCase(super.getEvaluatedValue(arguments));
    }
}
