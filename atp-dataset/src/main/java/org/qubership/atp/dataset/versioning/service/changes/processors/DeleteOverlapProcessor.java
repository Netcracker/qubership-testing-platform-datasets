...
@Component
@Order(11)
public class DeleteOverlapProcessor extends AbstractChangeProcessor {
    ...
    public HistoryItemDto createHistoryItem(
        ...
        ObjectRemoved removed = filterChangesByTypeAndAffectedType(diff, ObjectRemoved.class, "AttributeKey").get(0);
        AttributeKeyComparable attributeKey = (AttributeKeyComparable) removed.getAffectedObject().get();
        String dataSetName = getDataSetById(actualEntity, attributeKey.getDataSetId()).getName();
