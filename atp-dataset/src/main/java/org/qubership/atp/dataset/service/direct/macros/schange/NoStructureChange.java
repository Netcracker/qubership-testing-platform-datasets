...
public class NoStructureChange implements EvaluateDsStructureStrategy {
    private final DataSetRepository dsRepo;

    public NoStructureChange(DataSetRepository dsRepo) {
        this.dsRepo = dsRepo;
    }
    ...
    public DataSet getDataSetById(MixInId dataSet) {
        return dsRepo.getById(dataSet.getUuid());
    }
}
